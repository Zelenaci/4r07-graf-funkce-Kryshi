# -*- coding: utf-8 -*-
"""
Created on Mon Mar  4 14:20:14 2019
...
class App():
    ...
    def __init__(self,master):
        ...
        self.fileFrame = LabelFrame(master,text = "Grafy ze souboru",padx=5,pady=5)
        ...
        ######Osy######
        #okno popisků os
        self.axisFrame=LabelFrame(master, text="Popisky os",padx=5,pady=5,width=10)
    ...
    def pickfile(self):
        self.path=filedialog.askopenfilename(title="Vyber soubor")
